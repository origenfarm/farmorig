...
<section class="pd-desc-block">
  ...
  <ol class="pd-steps">
    <li><span class="pd-step-num">1</span><div><strong>Hidratación:</strong> tomas 1 cápsula con un vaso grande de agua antes del almuerzo y 1 antes de la cena (2 al día).</div></li>
...
<section class="pd-desc-block pd-desc-usage">
  <h4>Modo de uso</h4>
  <p><strong>1 cápsula</strong> con un vaso grande de agua (mínimo 250 ml), <strong>20 minutos antes</strong> del almuerzo, y <strong>1 cápsula más</strong> 20 minutos antes de la cena. Total: <strong>2 cápsulas al día</strong>.</p>
...
<section class="pd-desc-block pd-faq">
  ...
  <details>
    ...
    <p>1 cápsula 20 minutos antes del almuerzo y otra 20 minutos antes de la cena, con un vaso grande de agua (mínimo 250 ml). Total: 2 cápsulas al día.</p>
  </details>
  <details>
  ...
  <details>
    ...
    <p>El frasco de 30 cápsulas rinde aproximadamente <strong>15 días</strong> siguiendo el modo de uso sugerido (2 cápsulas al día: 1 antes del almuerzo + 1 antes de la cena). Para una rutina mensual, te conviene el pack <strong>Lleva 3 · Paga 2</strong>.</p>
  </details>
  <details>
  ...
  <details>
    ...
    <p>24 a 48 h hábiles en Región Metropolitana, Valparaíso y Biobío. 3 a 5 días para el resto del país. Despacho gratis en compras sobre $20.000.</p>
  </details>
</section>
